...
class AtomicToolsTester:
    ...
    # Test data extraction
            ...
            try:
                ...
                logger.info("DEBUG: Extracted data: %s", extracted)
                logger.info("DEBUG: condition value: '%s'", extracted.get("condition"))
                logger.info("DEBUG: Expected: 'sunny'")
                ...
                logger.error("Data extraction failed: %s", extract_error)
                raise
            ...
            logger.error("❌ AI tools test failed: %s", str(e))
            import traceback
